...
for(var i=0;i<data.length;i++) {
  ...
  li.id = "ItemTitle"
  li.innerHTML = "<div id='Title'>" + data[i]['title'] + "</div>"
  
  let index = i
  li.addEventListener('click', ()=>{
    li.innerHTML = "<div id='Title'>" + data[index]['title'] +"</div><p></p>" + "Director: " + data[index]['director'] + "<p></p>"  + "Description: " + "<p></p>" + data[index]['description'] 
    + "<p></p>" + "<a href=" + data[index]['url'] + ">More</a>"
...
button.addEventListener('click', ()=>{
  ...
  for(var i=0;i<children.length;i++) {
    children[i].innerHTML = "<div id='Title'>" + data[i]['title'] + "</div>"
  }
})